...
function CuratedList() {
  ...
  return (
    <>
     <h3 className="font-bold text-lg mt-6 mb-3" > Curated List</h3>
      <div className="flex flex-wrap gap-8">
        <Card
          className="flex flex-col items-center group cursor-pointer text-center p-4 "
          onClick={() => router.push("/store/repository/curated/summer")}
        >
          <img
            src="/camera.jpg"
            alt="img"
        ...
        <Card
          className="flex flex-col items-center group cursor-pointer text-center p-4"
          onClick={() => router.push("/store/repository/curated/winter")}
        >
          <img
            src="/camera.jpg"
            alt="img"
            className="w-40 h-40 object-cover mb-2 rounded-md"
          />
          <span className="capitalize text-base font-bold">Winter collection</span>
    ...
    {/* <Card>
      ...
      <CardContent>
        <h3 className="font-bold my-3">Summer Collection</h3>
        <Table>
          <TableHeader>
            <TableRow>
