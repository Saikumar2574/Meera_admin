...
import { ClipboardList, FileIcon, FolderIcon, FolderOpenIcon } from "lucide-react";
      ...
      >
        ...
        >
          {expandedItems?.includes(value)
            ? (openIcon ?? <ClipboardList className="size-4" />)
            : (closeIcon ?? <ClipboardList className="size-4" />)}
          <span>{element}</span>
        </AccordionPrimitive.Trigger>
